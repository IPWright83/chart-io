import{j as e}from"./jsx-runtime-vNq4Oc-g.js";import{M as c,C as i,b as n}from"./index-foGeVojo.js";import{u as r}from"./index-Dbo06S9W.js";import"./index-4g5l5LRQ.js";import"./_commonjsHelpers-4gQjN7DL.js";import"./iframe-5ZQv1v1p.js";import"../sb-preview/runtime.js";import"./index-jmm5gWkb.js";import"./index-GCvOZpsZ.js";import"./index-bjdz4q3G.js";import"./_baseIsEqual-ujzER7rs.js";import"./uniq-dzufyT16.js";import"./index-PPLHz8o0.js";function d(t){const s=Object.assign({h1:"h1",p:"p",code:"code",pre:"pre",h3:"h3",table:"table",thead:"thead",tr:"tr",th:"th",tbody:"tbody",td:"td",strong:"strong",a:"a",h2:"h2",ul:"ul",li:"li"},r(),t.components);return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Components/Axis"}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`<YAxis fields={["Profit", "Loss"]} />
`})}),`
...
`,e.jsxs(s.table,{children:[e.jsx(s.thead,{children:e.jsxs(s.tr,{children:[e.jsx(s.th,{children:"Prop"}),e.jsx(s.th,{children:"Type"}),e.jsx(s.th,{children:"Default"}),e.jsx(s.th,{children:"Note"})]})}),e.jsxs(s.tbody,{children:[e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsxs(s.strong,{children:[e.jsx(s.code,{children:"fields"}),"*"]})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"Array<string>"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"undefined"})}),e.jsx(s.td,{children:"The set of fields that this axis represents. These should correspond to the fields being displayed on this Axis within the data."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsxs(s.strong,{children:[e.jsx(s.code,{children:"position"}),"*"]})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"undefined"})}),e.jsxs(s.td,{children:["The position of the axis. One of ",e.jsx(s.code,{children:"top"}),", ",e.jsx(s.code,{children:"bottom"}),", ",e.jsx(s.code,{children:"left"})," or ",e.jsx(s.code,{children:"right"}),". This will use the appropriate ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axisTop",target:"_blank",rel:"nofollow noopener noreferrer",children:"d3.axis"})," orientation function."]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"showGridlines"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"boolean"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"true"})}),e.jsx(s.td,{children:"Determines whether gridlines should be shown against this axis."})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"tickFormat"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"function"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"null"})}),e.jsxs(s.td,{children:["See ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axis_tickFormat",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis#axis_tickFormat"})]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"ticks"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"any[]"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"null"})}),e.jsxs(s.td,{children:["See ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axis_ticks",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis#axis_ticks"})]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"tickSizeInner"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"number"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"6"})}),e.jsxs(s.td,{children:["See ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axis_tickSizeInner",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis#axis_tickSizeInner"}),"."]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"tickSizeOuter"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"number"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"6"})}),e.jsxs(s.td,{children:["See ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axis_tickSizeOuter",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis#axis_tickSizeOuter"}),"."]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"tickPadding"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"number"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"3"})}),e.jsxs(s.td,{children:["See ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axis_tickPadding",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis#axis_tickPadding"}),"."]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"tickValues"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string[]"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"null"})}),e.jsxs(s.td,{children:["See ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis#axis_tickValues",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis#axis_tickValues"})]})]}),e.jsxs(s.tr,{children:[e.jsx(s.td,{children:e.jsx(s.code,{children:"title"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"string"})}),e.jsx(s.td,{children:e.jsx(s.code,{children:"null"})}),e.jsx(s.td,{children:"The title of the axis. This will default to the value in field(s)"})]})]})]}),`
`,e.jsx("br",{}),`
...
`]}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--string-axis"})}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--boolean-axis"})}),`
...
`]}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--integer-axis"})}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--double-axis"})}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--double-axis-only-negative-axis"})}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--double-axis-mixed-sign-axis"})}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`<YAxis fields={["Sales_Revenue", "Consulting_Revenue"]} aggregate />
`})}),`
...
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`<XAxis fields="dayOfWeek" scaleType="band" />
`})}),`
...
`]}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--date-axis"})}),`
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-types--date-time-axis"})}),`
...
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-customization--gridlines"})}),`
...
`,e.jsxs(s.p,{children:["You can also adjust the following for your axis - refer to the d3-axis documentation for information on these advanced configuration options ",e.jsx(s.a,{href:"https://github.com/d3/d3-axis",target:"_blank",rel:"nofollow noopener noreferrer",children:"https://github.com/d3/d3-axis"}),":"]}),`
`,e.jsxs(s.ul,{children:[`
...
`,e.jsx(i,{children:e.jsx(n,{id:"components-axis-customization--fully-custom-axis"})}),`
`,e.jsx(s.p,{children:"The above can be produced with:"}),`
`,e.jsx(s.pre,{children:e.jsx(s.code,{children:`const CustomTimeAxis = ({ fields }) => {
...
`})})]})}function w(t={}){const{wrapper:s}=Object.assign({},r(),t.components);return s?e.jsx(s,Object.assign({},t,{children:e.jsx(d,t)})):d(t)}export{w as default};
//# sourceMappingURL=Axis-tDOMuB4e.js.map

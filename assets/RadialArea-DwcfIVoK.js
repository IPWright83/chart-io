...
`})}),`
`]}),`
`]})]})}function le(s={}){const{wrapper:r}={...n(),...s.components};return r?e.jsx(r,{...s,children:e.jsx(d,{...s})}):d(s)}export{le as default};
//# sourceMappingURL=RadialArea-DwcfIVoK.js.map

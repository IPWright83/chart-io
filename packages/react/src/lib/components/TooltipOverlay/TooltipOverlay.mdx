...
import * as TooltipOverlayStories from "./TooltipOverlay.stories";

<Meta title="Components/TooltipOverlay" />

# TooltipOverlay Component

The `<TooltipOverlay>` component allows us to overlay a [Tooltip](?path=/docs/components-tooltipoverlay-tooltip--docs) component containing multiple entries, which is useful for showing the information behind a data point when interacting with a chart.
...
<Canvas of={TooltipOverlayStories.Default} />
...
<Canvas of={TooltipOverlayStories.CustomTooltip} />
...
<Canvas of={TooltipOverlayStories.CustomTooltipItems} />

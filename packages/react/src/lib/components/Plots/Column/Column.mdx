...
<Meta title="Charts/XYCharts/Column" />
...
One way of combining Column plots is to display one over the top of the other. This is useful if you want to show one value as a ratio of another. Remember if you do this that you need to disable the default opacity on a bar.

<Canvas of={ColumnStories.Ratio} />
...
<Canvas of={ColumnStories.Stacked} />
...
<Canvas of={ColumnStories.Grouped} />

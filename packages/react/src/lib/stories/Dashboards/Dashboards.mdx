...
import * as DashboardStories from "./Dashboards.stories";

<Meta title="Dashboards" />

# Dashboards

One of the benefits of `@chart-io`'s extensibility is that it is simple to customize behaviour, including linking multiple charts together.

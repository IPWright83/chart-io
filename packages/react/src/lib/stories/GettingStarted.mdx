...
To get started with `@d3-chart` first ensure that you've installed the package using one of the following commands:

```
npm install @d3-chart/react  //npm
yarn add @d3-chart/react     // yarn
pnpm add @d3-chart/react     // pnpm
```

...
export interface IMarker {
    /**
     * The datum this marker represents, if any - lets it be right-clicked to open a "datum"
     * `<ContextMenu>` (e.g. "Hide data point"), the only way to reach one on a Line/Area/RadialArea,
     * which have no discrete per-point mark of their own to right-click. Omitted (and left
     * non-interactive) for markers that are purely a visual highlight, e.g. a Scatter point's halo
     */
    datum?: IDatum;

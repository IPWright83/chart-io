...
import { IColor, ICoordinate, IData, IMouseEventType, INumericValue, IScale } from "@chart-io/types";
 ...
 */
export function focus({ dispatch, layer, x, y, xScale, yScale, position, data, color, eventMode }: IAreaFocusProps) {

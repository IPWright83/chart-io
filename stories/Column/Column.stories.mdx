...
import { Chart, XAxis, YAxis, Column, Columns } from "../../src/components";

export const columnArgTypes = {
    ...defaultArgTypes,
};

<Meta title="XYCharts/1. Column" component={Column} argTypes={columnArgTypes} />
...
export const RatioColumnTemplate = (args) => (
    <div>
        <Chart {...args} data={sales_records_dataset}>
            ...
            <XAxis fields={[args.x]} scaleType="band" />
        </Chart>
    </div>
);

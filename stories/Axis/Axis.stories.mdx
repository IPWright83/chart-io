...
import { Chart, Axis, XAxis, YAxis } from "../../src/components";
...
<Meta title="Axis" component={Axis} argTypes={defaultArgTypes} />
...
<Story
    ...
    args={{
        ...commonDefaultArgs,
        x: "positiveAndNegativeDoubleValue",
        height: 100,
        width: 800,
    }}
>

...
import { huge_data_set } from "../huge_data_set";
import { Chart, XAxis, YAxis, Scatter, Scatters } from "../../src/components";

export const scatterArgTypes = {
    ...defaultArgTypes,
};

<Meta title="XYCharts/3. Scatter" component={Scatter} argTypes={scatterArgTypes} />
